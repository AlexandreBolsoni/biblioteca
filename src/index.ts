...
const livro6 = new Livro(6, "O Pequeno Priêncipe", "Antoine de Saint-Exupéry", 9788525057800, "Ficção Científica");
const livro7 = new Livro(7, "Harry Potter e a Pedra Filosofal", "J.K. Rowling", 9788532510578, "Fantasia");
const livro8 = new Livro(8, "Harry Potter e a Camara Secreta", "J.K. Rowling", 9788532510585, "Fantasia");
const livro9 = new Livro(9, "Harry Potter e o Prisioneiro de Azkaban", "J.K. Rowling", 9788532510592, "Fantasia");
...
const revista5 = new Revista(10, "The Guardian", "The Guardian", 9781449333330, new Date("2024-05-01"));
const revista6 = new Revista(11, "The Wall Street Journal", "The Wall Street Journal", 9781501175565, new Date("2024-06-01"));
...
const dependente1 = new Dependente(11, "Igor Gonçalves", 1);
const dependente2 = new Dependente(12, "adrian", 1);
const dependente3 = new Dependente(13, "pedro", 1);
const dependente4 = new Dependente(14, "alexandre", 1);

const titular1 = new Titular(1, "Archimedes", 1, [dependente1, dependente2]);
const titular2 = new Titular(2, "Bruno", 1, [dependente3, dependente4]); 
const titular3 = new Titular(3, "Milton", 1, []);
...
const locacao1 = new Locacao(1, titular1, livro1, new Date("2024-01-10"), new Date("2024-01-20"));
const locacao2 = new Locacao(2, titular2, livro2, new Date("2024-01-11"), new Date("2024-01-21"));
const locacao3 = new Locacao(3, titular1, revista1, new Date("2024-01-12"), new Date("2024-01-22"));
const locacao4 = new Locacao(4, titular3, livro3, new Date("2024-01-13"), new Date("2024-01-23"));
const locacao5 = new Locacao(5, titular3, revista2, new Date("2024-01-14"), new Date("2024-01-24"));
const locacao6 = new Locacao(6, titular2, revista3, new Date("2024-01-15"), new Date("2024-01-25"));
const locacao7 = new Locacao(7, dependente1, revista4, new Date("2024-01-16"), new Date("2024-01-26"));
const locacao8 = new Locacao(8, dependente2, revista5, new Date("2024-01-17"), new Date("2024-01-27"));
const locacao9 = new Locacao(9, dependente3, revista6, new Date("2024-01-18"), new Date("2024-01-28"));
const locacao10 = new Locacao(10, dependente4, livro4, new Date("2024-01-19"), new Date("2024-01-29"));
const locacao11 = new Locacao(11, dependente4, livro5, new Date("2024-01-20"), new Date("2024-01-30"));
const locacao12 = new Locacao(12, dependente3, livro6, new Date("2024-01-21"), new Date("2024-01-31"));
